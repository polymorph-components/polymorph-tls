...
| Case | composed | composed-delegated | composed-delegated-webcrypto | jco-browser | jco-browser-delegated | jco-node | jco-node-delegated |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| handshake (1 cases) | pass | pass | — | pass | pass | pass | pass |
| identity (1 cases) | pass | pass | — | pass | pass | pass | pass |
| shutdown (1 cases) | pass | pass | — | pass | pass | pass | pass |
